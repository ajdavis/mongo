...
//
////
//// Start a background cleanupOrphaned.
//// staticMongod:       Server to use for communication, use
////                     "MongoRunner.runMongod({})" to make one.
//// mongodURL:          Like 'localhost:31100'.
//// ns:                 Like 'dbName.collectionName'.
//// startingFromKey:    Optional, like { _id: 1 }, passed to cleanupOrphaned.
//// secondaryThrottle:  Optional, true or false, passed to cleanupOrphaned.
////
//// Returns a join function; call it to wait for moveChunk to complete. The join
//// function returns a command-response on completion or null on error.
////
//function cleanupOrphanedParallel(staticMongod, mongodURL, ns) {
//    var startingFromKey = arguments.length > 3 ? arguments[3] : null,
//        secondaryThrottle = arguments.length > 4 ? arguments[4] : null;
//
//    function runCleanupOrphaned(
//        mongodURL, ns, startingFromKey, secondaryThrottle) {
//
//        var mongod = new Mongo( mongodURL ),
//            admin = mongod.getDB( 'admin' ),
//            cmd = {cleanupOrphaned: ns};
//
//        if (startingFromKey) cmd.startingFromKey = startingFromKey;
//        if (secondaryThrottle) cmd.secondaryThrottle = secondaryThrottle;
//
//        printjson(cmd);
//        try {
//            return admin.runCommand(cmd);
//        } catch (e) {
//            print('cleanupOrphanedParallel error: ' + e);
//            return null;
//        }
//    }
//
//    // Return the join function.
//    return startParallelOps(
//        staticMongod, runCleanupOrphaned,
//        [mongodURL, ns, startingFromKey, secondaryThrottle]);
//}
